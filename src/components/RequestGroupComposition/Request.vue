        ...
        <b-col :md="show ? 6 : 12">
          <b-form>
            ...
            <custom-field
              ...
              :label="getFromObject(formConfig, ['request', 'mosaic_point_spacing', 'label'], 'Point Spacing')"
              :desc="getFromObject(formConfig, ['request', 'mosaic_point_spacing', 'desc'], '')"
              :hide="getFromObject(formConfig, ['request', 'mosaic_point_spacing', 'hide'], !mosaicIsAllowed)"
              :tooltip-config="tooltipConfig"
              :errors="null"
            />
            <custom-field
              ...
              :label="getFromObject(formConfig, ['request', 'mosaic_line_spacing', 'label'], 'Line Spacing')"
              :desc="getFromObject(formConfig, ['request', 'mosaic_line_spacing', 'desc'], '')"
              :hide="getFromObject(formConfig, ['request', 'mosaic_line_spacing', 'hide'], !mosaicIsAllowed)"
              :tooltip-config="tooltipConfig"
              :errors="null"
            />
            <custom-field
              ...
              :desc="getFromObject(formConfig, ['request', 'mosaic_orientation', 'desc'], '')"
            ...
            <custom-field
              ...
              :desc="getFromObject(formConfig, ['request', 'mosaic_num_rows', 'desc'], '')"
            ...
            <custom-field
              ...
              :desc="getFromObject(formConfig, ['request', 'mosaic_num_columns', 'desc'], '')"
            ...
            <custom-select
              ...
              :desc="getFromObject(formConfig, ['request', 'mosaic_center', 'desc'], '')"
