        ...
        <b-col :md="show ? 6 : 12">
          <b-form>
            ...
            <custom-field
              ...
              :desc="getFromObject(formConfig, ['configuration', 'dither_point_spacing', 'desc'], '')"
            ...
            <custom-field
              ...
              :desc="getFromObject(formConfig, ['configuration', 'dither_line_spacing', 'desc'], '')"
            ...
            <custom-field
              ...
              :desc="getFromObject(formConfig, ['configuration', 'dither_orientation', 'desc'], '')"
            ...
            <custom-field
              ...
              :desc="getFromObject(formConfig, ['configuration', 'dither_num_rows', 'desc'], '')"
            ...
            <custom-field
              ...
              :desc="getFromObject(formConfig, ['configuration', 'dither_num_columns', 'desc'], '')"
            ...
            <custom-select
              ...
              :desc="getFromObject(formConfig, ['configuration', 'dither_center', 'desc'], '')"
