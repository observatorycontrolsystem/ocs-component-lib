        ...
        <b-col :md="show ? 6 : 12">
          <b-form>
            ...
            <custom-select
              ...
              :desc="getFromObject(formConfig, ['configuration', 'dither', 'desc'], 'Pattern for generating offsets for a dithered set of instrument configurations')"
            ...
            <custom-field
              ...
              :desc="getFromObject(formConfig, ['configuration', 'dither_point_spacing', 'desc'], 'Spacing in the  Dec / vertical direction between offsets in the dither pattern')"
            ...
            <custom-field
              ...
              :desc="getFromObject(formConfig, ['configuration', 'dither_line_spacing', 'desc'], 'Spacing in the Ra / horizontal direction between offsets in the dither pattern')"
            ...
            <custom-field
              ...
              :desc="getFromObject(formConfig, ['configuration', 'dither_orientation', 'desc'], 'Angular Rotation of the pattern in degrees clockwise East (Ra) of North (Dec)')"
            ...
            <custom-field
              ...
              :desc="getFromObject(formConfig, ['configuration', 'dither_num_rows', 'desc'], 'Number of offsets in the grid in the Ra / horizontal direction')"
            ...
            <custom-field
              ...
              :desc="getFromObject(formConfig, ['configuration', 'dither_num_columns', 'desc'], 'Number of targets in the grid in the Dec / vertical direction')"
            ...
            <custom-select
              ...
              :desc="getFromObject(formConfig, ['configuration', 'dither_center', 'desc'], 'If True, the pattern is centered on the initial target. If False, the pattern begins at the initial target')"
